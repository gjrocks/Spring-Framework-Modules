...
<head>
    ...
    <title>Driver's License & IDs</title>
...
<body>
    ...
    <div class="inner">
      <a href="index.html">Home</a>
            ...
            <div class="starter-template">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                        <p>Please upload driving license copy :<br/> Note:- only .png .gif .jpg .jpeg formats are allowed</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                        <table style="margin-left: auto; margin-right: auto; text-align: left;">
                           ...
                           <!--<tr>
                                ...
                                <td>
                                    <select id="region-select" class="selectpicker" data-width="170px">
        ...
        <script src="/js/AcuantWebServiceJS/driverslicense.js"></script>
    </form>
</body>
</html>
